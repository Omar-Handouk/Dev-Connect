...
const ProfileUI = ({ hasProfile, data, displaySocialInputs, setDisplaySocialInputs, onChange, onSubmit }) => {
    ...
    return (
        <Fragment>
            ...
            <p className="lead">
                ...
                {hasProfile ? 'Add some changes to your profile' : 'Let\'s get some information to make your profile stand out'}
            </p>
            <small>* = required field</small>
            <form className="form" onSubmit={onSubmit}>
                <div className="form-group">
                    <select name="title" value={title} onChange={onChange}>
                        <option value="0">* Select Professional Title</option>
                ...
                <div style={{display: displaySocialInputs ? 'block' : 'none'}}>
...
ProfileUI.propTypes = {
    ...
    setDisplaySocialInputs: PropTypes.func.isRequired,
